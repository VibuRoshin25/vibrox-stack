...
_These diagrams should be updated when architectural changes are made. Use `/gen-arch-diagram` to regenerate architecture diagrams from the current codebase._
